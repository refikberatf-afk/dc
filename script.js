...
function updatePlayerList() {
    ...
    players.forEach((player, index) => {
        ...
        li.innerHTML = `${player} <button onclick="removePlayer(${index})" style="background:none; border:none; color:red; cursor:pointer;">Sil</button>`;
        list.appendChild(li);
    });
...
function nextTurn() {
    ...
    if (selectedMode === 'truth') {
        ...
        // Karışık mod: %60 Doğruluk, %40 Cesaret dengesi
